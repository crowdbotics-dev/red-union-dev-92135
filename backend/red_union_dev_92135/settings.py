"""
Django settings for red_union_dev_92135 project.
...
ROOT_URLCONF = 'red_union_dev_92135.urls'
...
WSGI_APPLICATION = 'red_union_dev_92135.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_union_dev_92135 API",
    "DESCRIPTION": "API documentation for red_union_dev_92135 App",
    "VERSION": "v1",
}
